...
public class MySqlDataLayer implements DataLayer {
    ...
    public List<PopulationReport> getPopulationOfPeopleInEachContinent() {
        return producePopulationReport("SELECT cntry.Continent,\n" +
                ...
                "GROUP BY cntry.Continent;", DataLayer.NO_LIMIT);
    }
    ...
    public List<PopulationReport> getPopulationOfPeopleInEachCountry() {
        return producePopulationReport("SELECT co.name as name, SUM(c.Population)as population_cities, SUM(co.Population) as population_total\n" +
                "FROM city c\n" +
                "JOIN country co on c.CountryCode = co.Code\n" +
    ...
    public SimplePopulationReport getThePopulationOfACity(String city) {
        return produceSimplePopulationReport("select city.name as name, population as population from city\n" +
                "where Name  = '" + city + "';");
    }
